...
import { DemoTradingScene } from "@/components/landing/demo-trading-scene"
...
const STEP_ICONS = [ChartLineIcon, ActivityIcon, ClipboardCheckIcon] as const
const STEP_KEYS = ["tape", "bracket", "track"] as const

export async function LandingDemoTrading() {
