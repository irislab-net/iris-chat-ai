  ...
  return (
    <Button
      ...
      className={cn(
        ...
        orientation === "horizontal"
          ? "-inset-s-1 top-1/2 -translate-y-1/2"
  ...
  return (
    <Button
      ...
      className={cn(
        "absolute touch-manipulation rounded-full",
        orientation === "horizontal"
          ? "-inset-e-1 top-1/2 -translate-y-1/2"
    ...
    >
      {Array.from({ length: total }, (_, index) => (
        <button
          ...
          className={cn(
            "size-1.5 rounded-full transition-[background-color,opacity]",
            index === selectedIndex
              ? "bg-muted-foreground/38 dark:bg-muted-foreground/45"
              : "bg-muted-foreground/20 hover:bg-muted-foreground/30 dark:bg-muted-foreground/25 dark:hover:bg-muted-foreground/35"
          )}
